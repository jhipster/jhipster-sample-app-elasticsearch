...
To optimize the sampleElasticSearch client for production, run:
...
* Project name: `sampleElasticSearch`
* Source Code Management
    * Git Repository: `git@github.com:xxxx/sampleElasticSearch.git`
