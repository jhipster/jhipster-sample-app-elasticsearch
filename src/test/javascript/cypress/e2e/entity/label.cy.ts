...
describe('Label e2e test', () => {
  ...
  let username: string;
  let password: string;
  const labelSample = { label: 'vision' };
  ...
  describe('Label page', () => {
    it('should have translated page title', () => {
      ...
      cy.getEntityHeading('Label').should('not.contain', 'jhipsterElasticsearchSampleApplicationApp.label.home.title');
    });
  ...
  describe('new Label page', () => {
    ...
    it('should create an instance of Label', () => {
      cy.get(`[data-cy="label"]`).type('below suffice');
      cy.get(`[data-cy="label"]`).should('have.value', 'below suffice');
