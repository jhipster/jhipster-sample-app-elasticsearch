...
describe('BankAccount e2e test', () => {
    ...
    it('should load BankAccounts', async () => {
        ...
        expect(await bankAccountComponentsPage.getTitle()).toMatch(/jhipsterElasticsearchSampleApplicationApp.bankAccount.home.title/);
    });
    ...
    it('should delete last BankAccount', async () => {
        ...
        expect(await bankAccountDeleteDialog.getDialogTitle()).toMatch(
            /jhipsterElasticsearchSampleApplicationApp.bankAccount.delete.question/
        );
