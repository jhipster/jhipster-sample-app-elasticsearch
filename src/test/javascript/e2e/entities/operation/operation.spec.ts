...
describe('Operation e2e test', () => {
  ...
  it('should load Operations', async () => {
    ...
    expect(await operationComponentsPage.getTitle()).to.eq('jhipsterElasticsearchSampleApplicationApp.operation.home.title');
  });
  ...
  it('should load create Operation page', async () => {
    ...
    expect(await operationUpdatePage.getPageTitle()).to.eq('jhipsterElasticsearchSampleApplicationApp.operation.home.createOrEditLabel');
  ...
  it('should delete last Operation', async () => {
    ...
    expect(await operationDeleteDialog.getDialogTitle()).to.eq('jhipsterElasticsearchSampleApplicationApp.operation.delete.question');
